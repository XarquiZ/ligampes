...
import { ArrowLeft, Loader2, Trophy, Eye, EyeOff } from 'lucide-react'
    ...
    return (
        <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4 relative">
            ...
            <div className="mb-8 text-center flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-emerald-700 rounded-2xl flex items-center justify-center mb-4 shadow-lg shadow-green-500/20">
                    <Trophy className="w-8 h-8 text-white" />
                </div>
                <h1 className="text-3xl font-black text-white tracking-tight">LIGA.ON</h1>
                <p className="text-zinc-500 font-medium">Gestão Profissional de Campeonatos</p>
            </div>

            <Card className="w-full max-w-md bg-zinc-900 border-zinc-800 shadow-2xl">
                <CardHeader className="text-center pb-2">
                    <CardTitle className="text-xl text-white">Acessar sua Conta</CardTitle>
                    <CardDescription>Entre para gerenciar ou acompanhar sua liga</CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardFooter className="justify-center border-t border-zinc-800 pt-6">
                    <p className="text-xs text-zinc-500">
                        Não tem uma conta? <Link href="/criar" className="text-green-500 hover:underline">Criar Liga</Link>
                    </p>
                </CardFooter>
            </Card>
        </div>
