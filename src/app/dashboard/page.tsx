...
import { supabase } from '@/lib/supabase' // ← seu cliente já configurado com PKCE
...
export default function Dashboard() {
  ...
  const frasesDeImpacto = user?.email === 'wellinton.sbatista@gmail.com'
          ...
          <div className="flex items-center gap-5">
            <div className="hidden text-right md:block">
              ...
              <p className="text-lg font-bold text-white flex items-center gap-2">
                ...
                {frasesDeImpacto && <Crown className="h-5 w-5 text-yellow-500" />}
              </p>
            </div>
