    ...
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-4 md:p-6 border border-yellow-500/20">
      ...
      <div className="flex space-x-2 md:space-x-4 mb-6 overflow-x-auto pb-2 scrollbar-hide">
        <button
          ...
          className={`px-4 py-2 rounded-lg transition-colors whitespace-nowrap ${activeTab === "artilharia"
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg transition-colors whitespace-nowrap ${activeTab === "assistencias"
            ? "bg-yellow-500 text-black font-semibold"
            : "bg-gray-900 text-gray-300 hover:bg-gray-700"
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg transition-colors whitespace-nowrap ${activeTab === "posicao"
            ? "bg-yellow-500 text-black font-semibold"
            : "bg-gray-900 text-gray-300 hover:bg-gray-700"
            }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded-lg transition-colors whitespace-nowrap ${activeTab === "times"
            ? "bg-yellow-500 text-black font-semibold"
            : "bg-gray-900 text-gray-300 hover:bg-gray-700"
            }`}
        >
