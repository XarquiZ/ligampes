    ...
    return (
      <div className="bg-gray-900/70 rounded-xl overflow-hidden p-8 text-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-yellow-400">Carregando tabela da Série B...</div>
        </div>
      </div>
    );
  }
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center justify-center gap-6 text-sm text-gray-400">
            <div className="flex items-center gap-2">
              ...
              <span>Acesso Direto (1º-3º)</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-orange-500/20 rounded-full border border-orange-500"></div>
              <span>Playoff Acesso</span>
            </div>
            <div className="flex items-center gap-2">
