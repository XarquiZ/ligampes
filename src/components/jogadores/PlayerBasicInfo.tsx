  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 text-xs lg:text-sm">
        <div>
          <span className="text-zinc-500">Idade:</span> <strong className="text-zinc-100 ml-1">{age ?? '-'}</strong>
        </div>
        <div>
          <span className="text-zinc-500 flex items-center gap-2">
            <Ruler className="w-3 h-3 lg:w-4 lg:h-4" />
            Altura: <strong className="ml-1 lg:ml-2 text-zinc-100">{formatHeight(height)}</strong>
          </span>
        </div>
        <div>
          <span className="text-zinc-500">Nacionalidade:</span> <strong className="text-zinc-100 ml-1">{nationality}</strong>
        </div>
        <div>
          <span className="text-zinc-500">Pé:</span> <strong className="text-zinc-100 ml-1">{preferred_foot}</strong>
        </div>
      </div>
